...
\title[Grupos de Heintze diagonales]{Crecimiento de bolas geodésicas en grupos de Heintze diagonales}
\date{16 de diciembre de 2025}
\author{Israel García}
\institute{IMATE Cuernavaca \\ UNAM}
...
\end{frame}
\section{Grupos abelianos diagonales}
\begin{frame}
...
\begin{frame}
	...
	\end{itemize}
\end{frame}
\subsection{Geometría de grupos de Heintze}
\begin{frame}
...
\end{frame}
\begin{frame}
	{Geometría en $\mathbb{R}^2\rtimes_{diag(1, 0.5)} \mathbb{R}$}
	\begin{minipage}
		[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{log-model} \\
		\includegraphics[width=\linewidth]{geodesic} 
	\end{minipage} \hfil
	\begin{minipage}
		[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{half-plane}	
		\begin{itemize}
			\item \underline{\href{https://www.kaggle.com/code/renegarxia/geodesic-sphere-heintze-group}{Cuaderno de trabajo}}
			\item \underline{\href{https://colab.research.google.com/drive/1V3Q33ysTzH1UYRi2ezewIQ3hhsjbHH49?usp=sharing}{Versión interactiva}}
			\item \underline{\href{https://www.geogebra.org/m/gzftxhfe}{Disco hiperbólico}}
		\end{itemize}
	\end{minipage}
\end{frame}
\begin{frame}
...
\begin{frame}[shrink=10]
	...
	\end{proof}
\end{frame}
\subsection{Volumen de bolas geodésicas}
...
\begin{frame}
	{Comentarios}
	\begin{itemize}
		\item En general la curvatura de $\mathbb{R}^{n}\rtimes_{A}\mathbb{R}$ depende de la parte simétrica y antisimétrica de $A$.
		\item Si $A$ no es diagonalizable ya no es posible utilizar el criterio de estabilidad para estimar el volumen.
		\item Problema abierto: Si $[\mathfrak{g}, \mathfrak{g}]$ no es abeliano, ¿cuáles son las ecuaciones geodésicas y de transporte paralelo?
		\begin{itemize}
		\item Por ejemplo, $H_{2n+1} \rtimes_{A} \mathbb{R}$, donde $H_{2n+1}$ es el grupo de Heisenberg.	
		\end{itemize}
	\end{itemize}
\end{frame}
\begin{frame}
	...
	\begin{thebibliography}{99}	
		\bibitem{horocyclic} Woess, W., 2013. What is a horocyclic product, and how is it related to lamplighters? Internationale Mathematische Nachrichten 67, 1–27. \url{https://www.oemg.ac.at/db/IMN/224}
		
		\bibitem{heintze} Heintze, E., 1974. On homogeneous manifolds of negative curvature. Math. Ann. 211, 23–34. \url{https://doi.org/10.1007/BF01344139}
		
		\bibitem{preprint} IGL, Volume Entropy Of A Family Of Rank One, Split-Solvable Lie Groups Of Abelian Type. Preprint disponible en \url{https://arxiv.org/abs/2410.10631}
